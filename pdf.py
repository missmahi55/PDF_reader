...
root.title("PDF Converter by SNEHA")
root.resizable(0, 0)
try:
...
readPdf = Text(root, font=('calibri', 12), fg='orange', bg='indigo', width=60, height=30, bd=10)
...
save2Word = Button(root, text="Save to Word File", font=('arial', 10, 'bold'),
                   bg="GREEN", fg='WHITE', command=save2word)
